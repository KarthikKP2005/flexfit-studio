...
export default function LoginPage() {
  ...
  const login = trpc.auth.login.useMutation({
    onSuccess: async (data) => {
      ...
      // Previously, all users were redirected to /dashboard (member view).
      // Now, trainers land on their schedule, admins on their dashboard,
      // and members on the member dashboard, reducing friction.
